...
export function Topbar({ route, role, onRoleChange }: { route: Route; role: Role; onRoleChange: (role: Role) => void }) {
  const titles: Record<Route, string> = { dashboard: 'Overview', submit: 'Submit an event', assignment: 'Coordinator assignment', manage: 'Event information', review: 'Request review' }
